...
export function SetupDialog({ onComplete }: Props) {
  ...
  return (
    <div className="relative w-full max-w-md mx-4">
      ...
      <div className="relative rounded-xl border border-stone-800 bg-stone-950/80 backdrop-blur-sm p-7 shadow-2xl">
        {/* Header */}
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            <h1 className="font-display text-2xl text-stone-100 leading-tight">Ersteinrichtung</h1>
          </div>
        </div>
        <p className="text-stone-500 text-[13px] mt-2 mb-6">
          Willkommen! Lege jetzt den ersten Benutzer an, um zu starten.
        </p>
