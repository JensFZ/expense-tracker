...
function CategoryModal({ initial, onClose, onSave }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4">
      ...
      <div className="relative w-full sm:max-w-md animate-scale-in glass-card p-6 space-y-5 max-h-[90vh] overflow-y-auto rounded-t-2xl sm:rounded-xl">
...
function SavingsDepositModal({ category, onClose, onSaved }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4">
      <div className="absolute inset-0 bg-black/80 backdrop-blur-md" onClick={onClose} />
      <div className="relative w-full sm:max-w-sm animate-scale-in glass-card p-6 space-y-4 rounded-t-2xl sm:rounded-xl">
        <div className="sm:hidden w-10 h-1 bg-stone-700 rounded-full mx-auto -mt-2 mb-1" />
        <div className="flex items-center justify-between">
